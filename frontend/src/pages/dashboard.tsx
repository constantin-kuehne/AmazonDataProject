  ...
  return (
    <div>
      ...
      <h3> Number of reviews per month</h3>
        ...
        <p>Durch starkes Ansteigen oder Absteigen der Anzahl an Reviews lassen sich gewisse Trends erkennen. Beispielsweise, ob ein Produkt gerade beliebt ist oder ob es ein Ersatzprodukt gibt. </p>
      <LineChart
      ...
      <h3> Amount of helpful votes</h3>
        <p>Der zweite Scatter Plot in unserem Dashboard ist darauf ausgelegt, die Qualität der Reviews darzustellen. Auf der x-Achse wird der prozentuale Anteil der helpful Votes an den total Votes dargestellt, auf der y-Achse wird wieder die Anzahl an Reviews gezeigt. </p>
      ...
      <h3> Star-rating & amount of reviews  </h3>
        <p>Dieser Scatter Plot zeigt auf der x-Achse die durchschnittliche Anzahl an Sternebewertungen (0-5), auf der y-Achse wird angezeigt, wie viele Reviews, dass Produkt insgesamt hat.  </p>
        <p>Das gesuchte Produkt wird durch einen orangen Punkt gekennzeichnet. Die anderen Punkte, die der Scatter plot darstellt, sind die 100 ähnlichsten Produkte derselben Kategorie.  </p>
        <p>Die Position des gesuchten Produktes (orange) soll die Beliebtheit des Produktes widerspiegeln, umso weiter oben rechts in der Ecke sich das Produkt befindet, desto beliebter ist es bei anderen Kunden. </p>
      <ScatterPlotTwo
        searchedProduct={searchedProduct}
        width={1000}
        height={500}
